...
function LeftSideBar() {
  return (
    <div className='w-[20%]'>
      <div className='ml-2'>
        <img src="https://img.freepik.com/free-vector/twitter-new-2023-x-logo-white-background-vector_1017-45422.jpg?w=740&t=st=1715345345~exp=1715345945~hmac=691454d70da95bcec6d69886b756eed7b95dbb0b306882d650c95f62a2cdc369" alt='' width={"40px"}></img>
      </div>
      <div className='my-4'>
        ...
        <div className='flex items-center  my-5 hover:bg-gray-200 rounded-full hover:cursor-pointer px-4 py-2'>
        <IoIosNotifications  size={"25px"} className='mr-5'/><h3 className='font-bold text-left'>Notification</h3>
        </div>
        <div className='flex items-center  my-5 hover:bg-gray-200 rounded-full hover:cursor-pointer px-4 py-2'>
